...
class draw:
    ...
    def draw_conclusion_table(self):
        ...
        data = [['Flute','3-stage','RV32I',sum(self.count_r),sum(self.__list4_reg),sum(self.__list4_reg)/len(self.__list4_reg),sum(self.__list2_lines),sum(self.__list2_lines)/len(self.__list2_lines)]]
        #print(data)
