...
module mkBranch_Predictor(CLK,
  ...
  reg [31 : 0] _theResult_____1_fst__h6857,
	       _theResult_____1_fst__h6901,
	       pred_PC__h6762;
  reg [1 : 0] _theResult_____1_snd__h6858, _theResult_____1_snd__h6902;
  wire [511 : 0] IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d78;
  wire [447 : 0] IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d63;
  wire [31 : 0] IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d73,
		_theResult_____1__h2391,
		_theResult_____1_fst__h6790,
		_theResult____h2390,
		pred_pc__h3020,
		pred_pc__h3022;
  wire [1 : 0] _theResult_____1_snd__h6791;
  wire NOT_bp_train_instr_BITS_11_TO_7_8_EQ_bp_train__ETC___d58;
  ...
  assign MUX_btb_bramcore2$b_put_1__SEL_1 =
	     EN_bp_train && pred_PC__h6762 != 32'hFFFFFFFF ;
  assign MUX_btb_bramcore2$b_put_3__VAL_1 =
	     { 1'd1, bp_train_cf_info[96:75], pred_PC__h6762[31:1] } ;
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd__h6791)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd__h6791;
  ...
  assign rg_ras$D_IN =
	     ((bp_train_instr[6:0] == 7'b1101111 ||
	      ...
	      (bp_train_instr[11:7] == 5'd1 ||
	       ...
	       { IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d63,
		 IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d73,
		 bp_train_pc + 32'd4 } :
	       IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d78 ;
  ...
  // remaining internal signals
  assign IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d63 =
	     (bp_train_instr[6:0] == 7'b1100111 &&
	      (bp_train_instr[19:15] == 5'd1 ||
	       bp_train_instr[19:15] == 5'd5) &&
	      NOT_bp_train_instr_BITS_11_TO_7_8_EQ_bp_train__ETC___d58) ?
	       rg_ras[511:64] :
	       rg_ras[479:32] ;
  assign IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d73 =
	     (bp_train_instr[6:0] == 7'b1100111 &&
		...
		bp_train_instr[19:15] == 5'd5) &&
	       ...
	       rg_ras[63:32] :
	       rg_ras[31:0] ;
  assign IF_bp_train_instr_BITS_6_TO_0_4_EQ_0b1100111_6_ETC___d78 =
	     (bp_train_instr[6:0] == 7'b1100111 &&
	      (bp_train_instr[11:7] != 5'd1 && bp_train_instr[11:7] != 5'd5 &&
	       (bp_train_instr[19:15] == 5'd1 ||
		bp_train_instr[19:15] == 5'd5) ||
		...
		bp_train_instr[19:15] == 5'd5) &&
	       ...
	       rg_ras ;
  assign NOT_bp_train_instr_BITS_11_TO_7_8_EQ_bp_train__ETC___d58 =
  ...
  assign _theResult_____1__h2391 =
	     (_theResult____h2390 == 32'hFFFFFFFF && btb_bramcore2$DOA[53] &&
	      btb_bramcore2$DOA[52:31] == rg_pc[31:10]) ?
	       pred_pc__h3020 :
	       _theResult____h2390 ;
  assign _theResult_____1_fst__h6790 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_fst__h6857 :
	       _theResult_____1_fst__h6901 ;
  assign _theResult_____1_snd__h6791 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_snd__h6858 :
	       _theResult_____1_snd__h6902 ;
  assign _theResult____h2390 =
		...
		predict_rsp_instr[19:15] == 5'd5) &&
	       ...
	       rg_ras[31:0] :
	       32'hFFFFFFFF ;
  assign pred_pc__h3020 = { btb_bramcore2$DOA[30:0], 1'b0 } ;
  assign pred_pc__h3022 =
	     rg_pc + (predict_rsp_is_i32_not_i16 ? 32'd4 : 32'd2) ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_fst__h6857 = bp_train_cf_info[63:32];
      2'b01, 2'b10, 2'b11:
	  _theResult_____1_fst__h6857 = bp_train_cf_info[31:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h6901 = bp_train_cf_info[63:32];
      2'b11: _theResult_____1_fst__h6901 = bp_train_cf_info[31:0];
    endcase
  end
  always@(bp_train_cf_info or _theResult_____1_fst__h6790)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: pred_PC__h6762 = _theResult_____1_fst__h6790;
      2'd1, 2'd2: pred_PC__h6762 = bp_train_cf_info[31:0];
      2'd3: pred_PC__h6762 = 32'hFFFFFFFF;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h6858 = 2'b01;
      2'b01: _theResult_____1_snd__h6858 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h6858 = 2'b11;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h6902 = 2'b0;
      2'b10: _theResult_____1_snd__h6902 = 2'b01;
      2'b11: _theResult_____1_snd__h6902 = 2'b10;
    endcase
  end
